//
//  LPLearningContentViewController.m
//  LearningPrj
//
//  Created by PanKyle on 14-5-22.
//  Copyright (c) 2014年 PanKyle. All rights reserved.
//

#import "LPLearningContentViewController.h"
...
{
    return [self.dailyContent count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = self.dailyContent[indexPath.row];
